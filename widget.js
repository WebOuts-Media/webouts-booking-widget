...
(function () {
  function init() {
    ...
    // Text-message consent under the mobile number field. Carriers (A2P 10DLC)
    // need this wording at the point where providers give us their number.
    try {
      var phoneEl = document.getElementById('wo_phone');
      var phoneField = phoneEl && phoneEl.closest ? phoneEl.closest('.wo-field') : null;
      if (phoneField && !document.getElementById('wo-sms-consent')) {
        var consent = document.createElement('p');
        consent.id = 'wo-sms-consent';
        consent.className = 'wo-sms-consent';
        consent.innerHTML = 'By providing your mobile number, you agree to receive text messages from WebOuts about your interview and filming, including scheduling updates, reminders and a link to your finished video. Message frequency varies. Msg &amp; data rates may apply. Reply STOP to opt out, HELP for help. See our <a href="https://webouts.com/sms-terms/" target="_blank" rel="noopener">Terms</a> and <a href="https://webouts.com/privacy/" target="_blank" rel="noopener">Privacy Policy</a>.';
        phoneField.appendChild(consent);
      }
    } catch (e) { /* never block booking over the notice */ }
